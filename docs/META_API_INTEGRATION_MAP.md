...
- **Rate Limits**: Warnings at ~180 calls/hour.
  - Code 17 (user request limit): backoff and retry.
  - Code 4 (application limit): backoff and retry.
  - Code 100 (invalid parameter): do not retry.
...
- Strategy overview (root-level): [`META_ADS_OPTIMIZATION_STRATEGY.md`](../META_ADS_OPTIMIZATION_STRATEGY.md)
